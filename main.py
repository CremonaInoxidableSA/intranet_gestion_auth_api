...
from routes.produccion.obtener_encargados_produccion import router as obtener_encargados_produccion_router
...
app.include_router(obtener_encargados_produccion_router)
